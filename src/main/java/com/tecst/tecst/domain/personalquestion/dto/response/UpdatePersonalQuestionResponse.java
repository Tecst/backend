...
@Getter
@AllArgsConstructor
public class UpdatePersonalQuestionResponse {
    ...
    public static UpdatePersonalQuestionResponse from(PersonalQuestion personalQuestion) {
        return new UpdatePersonalQuestionResponse(personalQuestion.getPersonalQuestionId(),
